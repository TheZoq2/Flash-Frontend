...
var _rtfeldman$elm_css$Css_File$toFileStructure = function (stylesheets) {
	var asTuple = function (_p0) {
		var _p1 = _p0;
		return {
			success: _elm_lang$core$List$isEmpty(_p1._1.warnings),
			filename: _p1._0,
			content: _p1._1.css
		};
	};
...
var _user$project$Style$primaryBackgroundColor = _rtfeldman$elm_css$Css$hex('1c1c1c');
var _user$project$Style$globalStyle = _rtfeldman$elm_css$Css$stylesheet(
	_elm_lang$core$Native_List.fromArray(
		[
			_rtfeldman$elm_css$Css_Elements$body(
			_elm_lang$core$Native_List.fromArray(
				[
					_rtfeldman$elm_css$Css$backgroundColor(_user$project$Style$primaryBackgroundColor)
				]))
		]));
var _user$project$Style$cssFiles = _rtfeldman$elm_css$Css_File$toFileStructure(
	_elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'GlobalStyle.css',
			_1: _rtfeldman$elm_css$Css_File$compile(_user$project$Style$globalStyle)
		}
		]));
var _user$project$Style$primaryTextColor = _rtfeldman$elm_css$Css$hex('ffffff');
var _user$project$Style$toStyle = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Style$tagListContainer = _elm_lang$core$Native_List.fromArray(
	[
		_rtfeldman$elm_css$Css$width(
		_rtfeldman$elm_css$Css$pct(100))
	]);
var _user$project$Style$albumItemContainer = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$Style$albumContainer = _elm_lang$core$Native_List.fromArray(
	[
...
var _user$project$Style$files = _elm_lang$core$Native_Platform.outgoingPort(
	'files',
	function (v) {
...
var _user$project$Style$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: {ctor: '_Tuple0'},
				_1: _user$project$Style$files(_user$project$Style$cssFiles)
			},
			view: function (_p1) {
				return A2(
...
var _user$project$Style$TagListContainer = {ctor: 'TagListContainer'};
var _user$project$Style$AlbumItemContainer = {ctor: 'AlbumItemContainer'};
var _user$project$Style$AlbumContainer = {ctor: 'AlbumContainer'};

var _user$project$TagListManager$getSelectedTags = function (model) {
	var isEnabled = function (tag) {
		return _elm_lang$core$Native_Utils.eq(tag.enable, true);
	};
	return A2(
		_elm_lang$core$List$map,
		function (_) {
		...
		A2(_elm_lang$core$List$filter, isEnabled, model.tags));
};
var _user$project$TagListManager$getTagList = function (model) {
	return A2(
		_elm_lang$core$List$map,
		function (tag) {
			return tag.name;
...
var _user$project$TagListManager$Model = F3(
	function (a, b, c) {
		return {tags: a, nextId: b, currentTextFieldText: c};
	});
var _user$project$TagListManager$init = A3(
	_user$project$TagListManager$Model,
	_elm_lang$core$Native_List.fromArray(
		[]),
	0,
	'');
var _user$project$TagListManager$Tag = F3(
	function (a, b, c) {
		return {id: a, name: b, enable: c};
	});
var _user$project$TagListManager$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'AddTag':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						tags: A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									A3(_user$project$TagListManager$Tag, model.nextId, model.currentTextFieldText, true)
								])),
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						tags: A2(
							_elm_lang$core$List$filter,
							function (tag) {
								return !_elm_lang$core$Native_Utils.eq(tag.id, _p0._0);
							},
							model.tags)
					});
			case 'InputChanged':
				return _elm_lang$core$Native_Utils.update(
					model,
					{currentTextFieldText: _p0._0});
			default:
				var toggleWithId = function (tag) {
					return _elm_lang$core$Native_Utils.eq(tag.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						tag,
						{
							enable: _elm_lang$core$Native_Utils.eq(tag.enable, false)
						}) : tag;
				};
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						tags: A2(_elm_lang$core$List$map, toggleWithId, model.tags)
					});
		}
	});
var _user$project$TagListManager$ToggleTag = function (a) {
	return {ctor: 'ToggleTag', _0: a};
};
var _user$project$TagListManager$InputChanged = function (a) {
	return {ctor: 'InputChanged', _0: a};
};
var _user$project$TagListManager$RemoveTag = function (a) {
	return {ctor: 'RemoveTag', _0: a};
};
var _user$project$TagListManager$viewTag = function (tag) {
	var toggleState = _elm_lang$core$Native_Utils.eq(tag.enable, true) ? 'enabled' : 'disabled';
	return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$TagListManager$ToggleTag(tag.id))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(toggleState)
							])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(
								_user$project$TagListManager$RemoveTag(tag.id))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
...
var _user$project$TagListManager$AddTag = {ctor: 'AddTag'};
var _user$project$TagListManager$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Style$toStyle(_user$project$Style$tagListContainer)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onSubmit(_user$project$TagListManager$AddTag)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Events$onInput(_user$project$TagListManager$InputChanged),
								_elm_lang$html$Html_Attributes$value(model.currentTextFieldText)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _user$project$TagListManager$viewTag, model.tags))
			]));
};
var _user$project$TagListManager$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$TagListManager$init, update: _user$project$TagListManager$update, view: _user$project$TagListManager$view})
};

var _user$project$TagEditor$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$TagEditor$getSelectedTags = function (model) {
	var enabledTagContainers = A2(
		_elm_lang$core$List$filter,
		function (manager) {
			return _elm_lang$core$Native_Utils.eq(manager.enable, true);
		},
	...
	return _elm_lang$core$List$concat(
		A2(_elm_lang$core$List$map, _user$project$TagListManager$getSelectedTags, managers));
};
var _user$project$TagEditor$tagManagerUpdateHelper = F3(
	function (targetId, msg, container) {
		var manager = container.manager;
		return _elm_lang$core$Native_Utils.update(
			container,
			{
				manager: _elm_lang$core$Native_Utils.eq(targetId, container.id) ? A2(_user$project$TagListManager$update, msg, manager) : manager
			});
	});
var _user$project$TagEditor$initContainer = function (id) {
	return {id: id, manager: _user$project$TagListManager$init, enable: true};
};
var _user$project$TagEditor$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'TagListMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tagManagerList: A2(
								_elm_lang$core$List$map,
								A2(_user$project$TagEditor$tagManagerUpdateHelper, _p0._0, _p0._1),
								model.tagManagerList)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddTagManager':
				var nextId = model.nextId + 1;
				var newContainerList = A2(
					_elm_lang$core$Basics_ops['++'],
					model.tagManagerList,
					_elm_lang$core$Native_List.fromArray(
						[
							_user$project$TagEditor$initContainer(model.nextId)
						]));
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{tagManagerList: newContainerList, nextId: nextId}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ToggleListManager':
				var toggleWithId = function (manager) {
					return _elm_lang$core$Native_Utils.eq(manager.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						manager,
						{
							enable: _elm_lang$core$Native_Utils.eq(manager.enable, false)
						}) : manager;
				};
				var newContainerList = A2(_elm_lang$core$List$map, toggleWithId, model.tagManagerList);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			default:
				var newContainerList = A2(
					_elm_lang$core$List$filter,
					function (manager) {
						return !_elm_lang$core$Native_Utils.eq(manager.id, _p0._0);
					},
					model.tagManagerList);
				return {
					ctor: '_Tuple2',
...
var _user$project$TagEditor$TagListManagerContainer = F3(
	function (a, b, c) {
		return {id: a, manager: b, enable: c};
	});
var _user$project$TagEditor$Model = F2(
	function (a, b) {
		return {tagManagerList: a, nextId: b};
	});
var _user$project$TagEditor$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$TagEditor$Model,
		_elm_lang$core$Native_List.fromArray(
			[]),
		0),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$TagEditor$RemoveListManager = function (a) {
	return {ctor: 'RemoveListManager', _0: a};
};
var _user$project$TagEditor$ToggleListManager = function (a) {
	return {ctor: 'ToggleListManager', _0: a};
};
var _user$project$TagEditor$AddTagManager = {ctor: 'AddTagManager'};
var _user$project$TagEditor$TagListMsg = F2(
	function (a, b) {
		return {ctor: 'TagListMsg', _0: a, _1: b};
	});
var _user$project$TagEditor$viewFromTagManager = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2.id;
	var removeButton = A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onClick(
				_user$project$TagEditor$RemoveListManager(_p3))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('remove group')
			]));
	var toggleMsg = _elm_lang$core$Native_Utils.eq(_p2.enable, false) ? 'Enable group' : 'Disable group';
	var toggleButton = A2(
		_elm_lang$html$Html$button,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onClick(
				_user$project$TagEditor$ToggleListManager(_p3))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text(toggleMsg)
			]));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$TagEditor$TagListMsg(_p3),
				_user$project$TagListManager$view(_p2.manager))
			]));
};
var _user$project$TagEditor$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_elm_lang$core$List$map, _user$project$TagEditor$viewFromTagManager, model.tagManagerList),
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					...
					_user$project$TagEditor$getSelectedTags(model)),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$TagEditor$AddTagManager)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Add new tag group')
							]))
					]))));
};
var _user$project$TagEditor$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$TagEditor$init, update: _user$project$TagEditor$update, view: _user$project$TagEditor$view, subscriptions: _user$project$TagEditor$subscriptions})
};

var Elm = {};
Elm['TagEditor'] = Elm['TagEditor'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['TagEditor'], 'TagEditor', typeof _user$project$TagEditor$main === 'undefined' ? null : _user$project$TagEditor$main);
